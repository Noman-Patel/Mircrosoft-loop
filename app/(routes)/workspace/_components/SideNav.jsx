...
import { Bell, BellDotIcon, Loader2Icon } from "lucide-react";
...
{/*Creates a new Documenty */}
  const CreateNewDocument=async()=>{
    ...
    await setDoc(doc(db, 'workspaceDocuments', docId.toString()), {
      ...
      createdBy: user?.primaryEmailAddress?.emailAddress || null, // Use a fallback value (null) if undefined
      coverImage: null,
      emoji: null,
      id: docId,
  ...
  return (
    <div className='h-screen md:w-84 hidden md:block fixed bg-blue-50 p-5 shadow-md'>
